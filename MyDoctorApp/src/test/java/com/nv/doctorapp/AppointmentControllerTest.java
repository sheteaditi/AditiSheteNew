...
class AppointmentControllerTest {
	...
	// sample input
		Appointment sampleInput = new Appointment( 1,"25-08-2023","Confirm","Appointment Fixed", null, null, null, null);
	// expected output
		Appointment actualOutput = new Appointment(1,"25-08-2023","Confirm","Appointment Fixed", null, null, null, null);
		Appointment expectedOutput = new Appointment(1,"25-08-2023","Confirm","Appointment Fixed", null, null, null, null);
